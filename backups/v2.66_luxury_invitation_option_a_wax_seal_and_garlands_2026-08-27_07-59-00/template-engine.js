...
<body class="bg-champagne-cream text-deep-onyx font-body-lg text-lg selection:bg-antique-gold/20">
  ...
  <div id="waxSealCurtain" class="fixed inset-0 z-[9995] bg-[#0c0e14]/95 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center select-none transition-all duration-700">
    <div class="cursor-pointer group flex flex-col items-center animate-pulse-subtle" id="btnBreakWaxSeal">
      <div class="relative w-36 h-36 sm:w-44 sm:h-44 transition-transform duration-500 group-hover:scale-105 active:scale-95">
        <img src="assets/wax-seal-gold.jpg" alt="Sello de Cera Real" class="w-full h-full object-contain drop-shadow-[0_15px_35px_rgba(212,175,55,0.4)]" />
      </div>
