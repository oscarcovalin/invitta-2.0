...
<style>
  ...
  #tituloRsvpPergamino {
    font-family: var(--font-names, var(--font-display, 'Cormorant Garamond', serif)) !important;
    font-weight: 400 !important;
  ...
  #rsvpDeadlineText {
    font-family: var(--font-display, var(--font-names, 'Cormorant Garamond', serif)) !important;
  ...
  .form-group-clean label {
    ...
    margin-bottom: 7px;
    color: var(--gold);
    font-family: var(--font-display, var(--font-names, 'Cormorant Garamond', serif));
    font-size: 0.78rem;
    text-transform: uppercase;
    letter-spacing: 0.2em;
    font-weight: 600;
  ...
  .btn-rsvp-submit-clean {
    ...
    box-shadow: 0 6px 18px rgba(163, 128, 71, 0.28);
    margin-top: 12px;
  }

  .btn-rsvp-submit-clean:hover {
    background-color: var(--primary, #163C2B);
    color: #ffffff;
  ...
  .pass-ticket-pergamino h4 {
    font-family: var(--font-names, 'Cormorant Garamond', serif);
